...
export function AgentDetailsSidebar({ selectedAgentName, currentAgent, allTools }: AgentDetailsSidebarProps) {
  ...
  // Declarative and Sandbox share model-backed config (tools, skills on spec).
  const isDeclarativeLikeAgent =
    selectedTeam?.agent.spec.type === "Declarative" ||
    selectedTeam?.agent.spec.type === "Sandbox";
